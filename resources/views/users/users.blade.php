            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/user/create') }}" class="btn btn-success btn-sm" title="Add New User">
                        <i class="fa fa-plus" aria-hidden="true"></i> Add a new user
                    </a>
                    <br />
                    <br />
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $user->phone }}</td>
                                    <td>
                                        <!-- <a href="{{ url('/user/' . $user->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a> -->
